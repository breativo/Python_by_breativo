...
/ (dividir)-->(calcula la división de dos números enteros, en caso de no ser entera podríamos tener problemas)
% (modulo)-->(calcula el resto de la división entera entre ambos números)
